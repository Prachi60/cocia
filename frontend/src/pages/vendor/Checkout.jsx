    ...
    <div className="animate-in fade-in slide-in-from-right duration-300">
      ...
      <div className="bg-white p-4 shadow-sm mb-32">
        ...
        <p className="text-[11px] text-gray-400 text-center leading-relaxed">
          By continuing with the order, you confirm that you are above 18 years of age, and you agree to the Cocia's <span className="text-[#2874f0]">Terms of Use</span> and <span className="text-[#2874f0]">Privacy Policy</span>
        </p>
      </div>
    </div>
  );
        ...
        <div className="bg-white border-b border-gray-100">
           <div className="px-4 py-4 flex items-center justify-between">
             <div className="flex items-center gap-4">
                ...
                <h3 className="text-[14px] font-bold text-slate-800">Have a Cocia Gift Card?</h3>
             </div>
