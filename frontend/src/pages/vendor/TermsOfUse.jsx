      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            Welcome to Cocia! These Terms of Use ("Terms") govern your access to and use of the Cocia platform, 
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            All products and services offered on Cocia are subject to availability. We reserve the right to 
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            ...
            of Cocia or its licensors and is protected by copyright, trademark, and other intellectual property 
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            To the maximum extent permitted by law, Cocia shall not be liable for any indirect, incidental, 
        ...
        <section className="pb-8">
          ...
          <div className="text-[13px] text-gray-600 space-y-1 ml-2">
            <p>Email: support@cocia.com</p>
            <p>Phone: +91 1800-123-4567</p>
            <p>Address: Cocia Pvt Ltd, Mumbai, India</p>
          </div>
        </section>
      </div>
    </div>
