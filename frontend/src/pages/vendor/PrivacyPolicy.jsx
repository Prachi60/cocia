      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            At Cocia, we are committed to protecting your privacy and ensuring the security of your personal 
        ...
        <section className="pb-8">
          ...
          <div className="text-[13px] text-gray-600 space-y-1 ml-2">
            <p><strong>Email:</strong> privacy@cocia.com</p>
            <p><strong>Phone:</strong> +91 1800-123-4567</p>
            <p><strong>Address:</strong> Cocia Pvt Ltd, Data Protection Officer, Mumbai, India</p>
          </div>
          <div className="mt-4 p-4 bg-blue-50 border-l-4 border-[#2874F0] rounded">
