      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            At Cocia, we want you to be completely satisfied with your purchase. This policy outlines our 
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 text-center">
            <Clock size={24} className="text-[#2874F0] mx-auto mb-2" />
        ...
        <section>
          <div className="flex items-center gap-2 mb-3">
            <XCircle size={20} className="text-[#2874F0]" />
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-[13px] text-gray-600 space-y-1 ml-2">
            ...
            <li><strong>Store Credit:</strong> Instant credit to your Cocia wallet (optional)</li>
          </ul>
        ...
        <section className="pb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div className="text-[13px] text-gray-700 space-y-2">
              <p><strong>Email:</strong> returns@cocia.com</p>
