          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 bg-white">
              <p className="text-[15px] text-slate-700 font-medium leading-relaxed mb-6">
                Cocia Help Centre offers quick support for order tracking, returns, refunds, and delivery updates. Find more information on Cocia Plus, payments, and shopping here. Access support via guided topics, customer care number, or chat with a support executive. Find Help Centre in "My Account" on mobile app or in the main menu on the desktop app.
              </p>
