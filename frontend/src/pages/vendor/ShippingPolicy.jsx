      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <section>
          ...
          <p className="text-[13px] text-gray-600 leading-relaxed">
            At Cocia, we are committed to delivering your orders quickly and safely. This shipping policy 
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <ul className="list-disc list-inside text-[12px] text-gray-600 space-y-1 ml-2">
                    ...
                    <li>Cocia Plus members (all orders)</li>
        ...
        <section className="pb-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div className="text-[13px] text-gray-700 space-y-2">
              <p><strong>Email:</strong> shipping@cocia.com</p>
